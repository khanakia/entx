...
func (_q *AuditLogQuery) QueryTeam() *TeamQuery {
...
func (_q *AuditLogQuery) WithTeam(opts ...func(*TeamQuery)) *AuditLogQuery {
	query := (&TeamClient{config: _q.config}).Query()
...
func (_q *AuditLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AuditLog, error) {
	...
	if query := _q.withTeam; query != nil {
		if err := _q.loadTeam(ctx, query, nodes, nil,
			func(n *AuditLog, e *Team) { n.Edges.Team = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AuditLogQuery) loadTeam(ctx context.Context, query *TeamQuery, nodes []*AuditLog, init func(*AuditLog), assign func(*AuditLog, *Team)) error {
...
func (_q *AuditLogQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTeam != nil {
			_spec.Node.AddColumnOnce(auditlog.FieldTeamID)
		}
	}

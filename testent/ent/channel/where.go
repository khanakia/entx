...
func FolderID(v int) predicate.Channel {
	return predicate.Channel(sql.FieldEQ(FieldFolderID, v))
}
...
func FolderIDEQ(v int) predicate.Channel {
	return predicate.Channel(sql.FieldEQ(FieldFolderID, v))
}

// FolderIDNEQ applies the NEQ predicate on the "folder_id" field.
func FolderIDNEQ(v int) predicate.Channel {
	return predicate.Channel(sql.FieldNEQ(FieldFolderID, v))
}

// FolderIDIn applies the In predicate on the "folder_id" field.
func FolderIDIn(vs ...int) predicate.Channel {
	return predicate.Channel(sql.FieldIn(FieldFolderID, vs...))
}

// FolderIDNotIn applies the NotIn predicate on the "folder_id" field.
func FolderIDNotIn(vs ...int) predicate.Channel {
	return predicate.Channel(sql.FieldNotIn(FieldFolderID, vs...))
}

// FolderIDIsNil applies the IsNil predicate on the "folder_id" field.
func FolderIDIsNil() predicate.Channel {
	return predicate.Channel(sql.FieldIsNull(FieldFolderID))
}

// FolderIDNotNil applies the NotNil predicate on the "folder_id" field.
func FolderIDNotNil() predicate.Channel {
	return predicate.Channel(sql.FieldNotNull(FieldFolderID))
}

// HasFolder applies the HasEdge predicate on the "folder" edge.
func HasFolder() predicate.Channel {
...
func HasFolderWith(preds ...predicate.Folder) predicate.Channel {
	return predicate.Channel(func(s *sql.Selector) {
		step := newFolderStep()

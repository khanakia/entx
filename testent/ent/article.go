...
func (e ArticleEdges) RevisionsOrErr() ([]*Revision, error) {
	if e.loadedTypes[0] {
...
// QueryRevisions queries the "revisions" edge of the Article entity.
func (_m *Article) QueryRevisions() *RevisionQuery {
	return NewArticleClient(_m.config).QueryRevisions(_m)
}

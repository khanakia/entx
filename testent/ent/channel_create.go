...
func (_c *ChannelCreate) SetFolderID(v int) *ChannelCreate {
	_c.mutation.SetFolderID(v)
	return _c
}

// SetNillableFolderID sets the "folder_id" field if the given value is not nil.
func (_c *ChannelCreate) SetNillableFolderID(v *int) *ChannelCreate {
	if v != nil {
		_c.SetFolderID(*v)
	}
	return _c
...
func (_c *ChannelCreate) SetFolder(v *Folder) *ChannelCreate {

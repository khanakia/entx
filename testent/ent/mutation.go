...
func (m *AuditLogMutation) SetTeamID(i int) {
	m.team = &i
}

// TeamID returns the value of the "team_id" field in the mutation.
func (m *AuditLogMutation) TeamID() (r int, exists bool) {
	v := m.team
	if v == nil {
		return
	}
...
// OldTeamID returns the old "team_id" field's value of the AuditLog entity.
// If the AuditLog object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuditLogMutation) OldTeamID(ctx context.Context) (v *int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AuditLogMutation) ClearTeamID() {
	m.team = nil
	m.clearedFields[auditlog.FieldTeamID] = struct{}{}
}

// TeamIDCleared returns if the "team_id" field was cleared in this mutation.
func (m *AuditLogMutation) TeamIDCleared() bool {
	_, ok := m.clearedFields[auditlog.FieldTeamID]
	return ok
}

// ResetTeamID resets all changes to the "team_id" field.
func (m *AuditLogMutation) ResetTeamID() {
	m.team = nil
	delete(m.clearedFields, auditlog.FieldTeamID)
}

// ClearTeam clears the "team" edge to the Team entity.
func (m *AuditLogMutation) ClearTeam() {
	m.clearedteam = true
	m.clearedFields[auditlog.FieldTeamID] = struct{}{}
}

// TeamCleared reports if the "team" edge to the Team entity was cleared.
func (m *AuditLogMutation) TeamCleared() bool {
...
func (m *AuditLogMutation) TeamIDs() (ids []int) {
	if id := m.team; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *AuditLogMutation) ResetTeam() {
	m.team = nil
	m.clearedteam = false
}
...
func (m *AuditLogMutation) Fields() []string {
	...
	if m.team != nil {
		fields = append(fields, auditlog.FieldTeamID)
	}
	return fields
}
...
func (m *AuditLogMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(auditlog.FieldTeamID) {
		fields = append(fields, auditlog.FieldTeamID)
	}
	return fields
}
...
func (m *AuditLogMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.team != nil {
		edges = append(edges, auditlog.EdgeTeam)
	}
	return edges
}
...
func (m *TeamMutation) AddAuditLogIDs(ids ...int) {
	if m.audit_logs == nil {
...
func (m *TeamMutation) RemovedAuditLogsIDs() (ids []int) {
...
func (m *TeamMutation) AuditLogsIDs() (ids []int) {
...
func (m *TeamMutation) ResetAuditLogs() {
	m.audit_logs = nil
...
func (m *TeamMutation) AddedEdges() []string {
	...
	if m.audit_logs != nil {
		edges = append(edges, team.EdgeAuditLogs)
	}
	return edges
}

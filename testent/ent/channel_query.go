...
func (_q *ChannelQuery) QueryFolder() *FolderQuery {
...
func (_q *ChannelQuery) WithFolder(opts ...func(*FolderQuery)) *ChannelQuery {
	query := (&FolderClient{config: _q.config}).Query()
...
func (_q *ChannelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Channel, error) {
	...
	if query := _q.withFolder; query != nil {
		if err := _q.loadFolder(ctx, query, nodes, nil,
			func(n *Channel, e *Folder) { n.Edges.Folder = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ChannelQuery) loadFolder(ctx context.Context, query *FolderQuery, nodes []*Channel, init func(*Channel), assign func(*Channel, *Folder)) error {
...
func (_q *ChannelQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withFolder != nil {
			_spec.Node.AddColumnOnce(channel.FieldFolderID)
		}
	}

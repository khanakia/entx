...
func (_q *RevisionQuery) QueryArticle() *ArticleQuery {
...
func (_q *RevisionQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *RevisionQuery) FirstIDX(ctx context.Context) int {
...
func (_q *RevisionQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *RevisionQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *RevisionQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *RevisionQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RevisionQuery) WithArticle(opts ...func(*ArticleQuery)) *RevisionQuery {
	query := (&ArticleClient{config: _q.config}).Query()
...
func (_q *RevisionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Revision, error) {
	...
	if query := _q.withArticle; query != nil {
		if err := _q.loadArticle(ctx, query, nodes, nil,
			func(n *Revision, e *Article) { n.Edges.Article = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RevisionQuery) loadArticle(ctx context.Context, query *ArticleQuery, nodes []*Revision, init func(*Revision), assign func(*Revision, *Article)) error {
...
func (_q *RevisionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withArticle != nil {
			_spec.Node.AddColumnOnce(revision.FieldArticleID)
		}
	}

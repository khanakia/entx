...
func (_c *ImageCreate) SetImageableID(v string) *ImageCreate {
	_c.mutation.SetImageableID(v)
	return _c
}

// SetNillableImageableID sets the "imageable_id" field if the given value is not nil.
func (_c *ImageCreate) SetNillableImageableID(v *string) *ImageCreate {
	if v != nil {
		_c.SetImageableID(*v)
	}
	return _c
...
func (_c *ImageCreate) createSpec() (*Image, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ImageableID(); ok {

...
func (_c *CommentCreate) SetAuthorID(id string) *CommentCreate {
	_c.mutation.SetAuthorID(id)
	return _c
}

// SetNillableAuthorID sets the "author" edge to the User entity by ID if the given value is not nil.
func (_c *CommentCreate) SetNillableAuthorID(id *string) *CommentCreate {
	if id != nil {

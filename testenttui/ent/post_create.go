...
func (_c *PostCreate) SetNillableBody(v *string) *PostCreate {
	if v != nil {
		_c.SetBody(*v)
	}
	return _c
...
func (_c *PostCreate) SetAuthorID(id string) *PostCreate {
	_c.mutation.SetAuthorID(id)
	return _c
}

// SetNillableAuthorID sets the "author" edge to the User entity by ID if the given value is not nil.
func (_c *PostCreate) SetNillableAuthorID(id *string) *PostCreate {
	if id != nil {

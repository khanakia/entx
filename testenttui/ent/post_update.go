...
func (_u *PostUpdate) SetAuthorID(id string) *PostUpdate {
	_u.mutation.SetAuthorID(id)
	return _u
}

// SetNillableAuthorID sets the "author" edge to the User entity by ID if the given value is not nil.
func (_u *PostUpdate) SetNillableAuthorID(id *string) *PostUpdate {
	if id != nil {
...
// SetAuthorID sets the "author" edge to the User entity by ID.
func (_u *PostUpdateOne) SetAuthorID(id string) *PostUpdateOne {
	_u.mutation.SetAuthorID(id)
	return _u
}

// SetNillableAuthorID sets the "author" edge to the User entity by ID if the given value is not nil.
func (_u *PostUpdateOne) SetNillableAuthorID(id *string) *PostUpdateOne {
	if id != nil {
		_u = _u.SetAuthorID(*id)
	}
	return _u
